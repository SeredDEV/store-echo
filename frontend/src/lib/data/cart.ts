...
export async function retrieveCart(cartId?: string, fields?: string) {
  ...
  fields ??=
    "*items, *region, *items.product, *items.product.images, *items.product.variants, *items.product.variants.images, *items.variant, *items.variant.images, *items.thumbnail, *items.metadata, +items.total, *promotions, +shipping_methods.name"
