...
export default async function reindexMeilisearchSimple({ container }: ExecArgs) {
  try {
    console.log("🔄 Iniciando reindexación simple de productos en Meilisearch...")
    ...
    console.log("ℹ️  Los productos se indexarán automáticamente cuando se creen o actualicen")
    console.log("ℹ️  Para indexar productos existentes, créalos o actualízalos desde el admin")
  } catch (error) {
